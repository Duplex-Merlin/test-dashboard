export const training = [
  ...
  },
  {
    ...
    output:
      "Au service courrier de la direction générale sis à l’immeuble Siège à Messa ou envoyez votre demande via le formulaire à la page Ressources humaines.",
    code: "greetings.deposit",
  },
  {
    input: "Service client",
    output:
      "veuillez contacter notre service client au 222518080/ 679009630 ou sur WhatsApp au 698503219.\nNous sommes aussi disponible par mail à l'dresse : \nsupport@cca-bank.com.\n\nNous remercions pour votre fidélité et surtout pour votre patience.",
  ...
  },
  {
    input: "Salaire",
    output:
      "Bonjour M. XXXX, nous sommes conscients des difficultés que vous rencontrez pour toucher votre salaire. CCA-Bank, Facebook",
  ...
  },
  {
    ...
    output:
      "Bonjour M. XXXX, nous sommes conscients qu'une agence plus proche serait un atout pour nos clients dans cette zone. CCA-Bank, continue de développer son réseau dans le but d'avoir une plus grande  proximité avec ses clients pour leur faciliter l'accès  à leurs fonds. Votre fidélité nous honore.",
    code: "greetings.need",
  },
  {
    input: "Problème Technique DAB/ PB de réseau",
    output:
      "- Bonjour monsieur xxxxxxxx les équipes de CCA-Bank  travaillent à garantir en continue la qualité du réseau dans nos services. Nous remercions pour votre fidélité et surtout pour votre patience.\n\n - Bonjour monsieur XXXXX nous sommes sincèrement désolés pour ce désagrément.Nous mettons tout en œuvre pour développer des solutions qui amélioreront à votre expérience . Nous vous remercions pour votre fidélité et surtout pour votre patience.\n\n- Bonjour M. XXXX, nous sommes conscients des  difficultés que vous rencontrez pour toucher  votre salaire. CCA-Bank, votre banque continue de travailler à développer des solutions qui faciliteront à ses clients l'accès à leurs fonds. Votre fidélité nous honore.",
